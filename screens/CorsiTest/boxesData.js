const boxesData = [
  ...
  },
  {
    ...
    position: ['25%', '15%'],
    sequenceOrder: [2, 1],
    invertedSequenceOrder: [0, 0]
  },
  // {
  //   key: 0,
  //   color: 'blue',
  //   position: ['0%', '0%'],
  //   sequenceOrder: [1, 2, 4, 1, 1, 1, 1, 1],
